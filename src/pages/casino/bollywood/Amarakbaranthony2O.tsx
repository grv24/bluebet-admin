...
const Amarakbaranthony2OComponent = ({
  casinoData,
  remainingTime,
  results,
  gameSlug,
  ...
  // Keep original gameCode/gameSlug for API calls (e.g., "AAA_2")
  const apiGameType = React.useMemo(() => {
    return gameCode || gameSlug || "AAA_2";
  }, [gameCode, gameSlug]);
    ...
    <div className="flex flex-col gap-1 bg-[var(--bg-table-row)] mt-1.5">
      ...
      <div className="mt-1 flex flex-col gap-1">
        <div className="bg-[var(--bg-secondary85)] border border-gray-300 flex justify-between px-2 py-.5 items-center">
          ...
          <h2 
            onClick={() => navigate(`/reports/casino-result-report?game=${gameCode || gameSlug || "AAA_2"}`)}
      ...
      <IndividualResultModal
        ...
        title={`${gameName || "Amar Akbar Anthony 2.0"} Result Details`}
...
const Amarakbaranthony2O = memoizeCasinoComponent(Amarakbaranthony2OComponent);
Amarakbaranthony2O.displayName = "Amarakbaranthony2O";

export default Amarakbaranthony2O;

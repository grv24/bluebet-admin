...
const QueenTopComponent: React.FC<QueenTopProps> = ({
  casinoData,
  remainingTime,
  onBetClick,
  results = [],
...
const QueenTop = memoizeCasinoComponent(QueenTopComponent);
QueenTop.displayName = "QueenTop";

export default QueenTop;

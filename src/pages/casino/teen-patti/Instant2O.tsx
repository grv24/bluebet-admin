...
const Instant2OComponent: React.FC<Instant2OProps> = ({
  casinoData,
  remainingTime,
  onBetClick,
  results = [],
...
const Instant2O = memoizeCasinoComponent(Instant2OComponent);
Instant2O.displayName = "Instant2O";

export default Instant2O;

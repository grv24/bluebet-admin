...
const casinoTypes = ["Select Casino Type", "Type 1", "Type 2"];
const selectOptions = ["Select", "Option 1", "Option 2"];
const pageSizeOptions = [25, 50, 100];

const CasinoReport = () => {
  const [casinoType, setCasinoType] = useState(casinoTypes[0]);
  ...
  return (
    <div className="p-2 sm:p-4 bg-[#fafafa] min-h-screen">
      <h2 className="m-0 text-lg font-normal mb-2">Casino Report</h2>
      {/* Filter Row */}
      <div className="flex flex-col md:flex-row flex-wrap gap-2 md:gap-4 mb-4 w-full items-end">
        ...
        <input
          type="text"
          className="border border-gray-300 rounded px-3 py-2 text-sm text-gray-400 bg-[#f5f5f5] focus:border-gray-300 focus:ring-0 outline-none transition w-full md:w-[220px]"
        ...
        <table className="w-full min-w-[900px] border-separate border-spacing-0 text-sm">
          <thead>
            <tr className="bg-[#f5f5f5] text-left">
              <th className="py-2 px-2 font-semibold border border-[#e0e0e0]">Game Name</th>
              <th className="py-2 px-2 font-semibold border border-[#e0e0e0]">Type</th>
              <th className="py-2 px-2 font-semibold border border-[#e0e0e0]">Amount</th>
              <th className="py-2 px-2 font-semibold border border-[#e0e0e0]">Total</th>
              <th className="py-2 px-2 font-semibold border border-[#e0e0e0]">Date</th>
              <th className="py-2 px-2 font-semibold border border-[#e0e0e0]">Round Id</th>
              <th className="py-2 px-2 font-semibold border border-[#e0e0e0]">Transaction Id</th>
            </tr>
          </thead>
          <tbody>
            <tr>

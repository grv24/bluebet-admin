...
const SportMatchDetailsModal: React.FC<SportMatchDetailsModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 bg-black/60 flex items-start justify-center z-50 px-4">
      <div className="bg-white  shadow-xl max-w-7xl w-full max-h-[90vh] overflow-y-auto">
        {/* Modal Header */}
